        ...
        <div className="bg-zinc-950 min-h-screen text-zinc-300 antialiased font-light relative text-base md:text-lg">
            ...
            <div className="relative z-10 font-sans">
                ...
                <main className="max-w-4xl mx-auto px-6 py-32 md:py-40">
                    <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-white mb-2">Terms of Service</h1>
                    <p className="text-zinc-500 mb-12">Last Updated: 02/21/2026</p>

                    <div className="space-y-8 leading-relaxed">
                        <p className="uppercase tracking-wide font-medium text-zinc-400 text-sm">
                        ...
                        <p>
                            {'The present terms and conditions (this "Agreement" or "Terms") is a legal agreement between you and Chatbot Boy (hereinafter ""), a company duly organized and validly existing, located at 3139 W Holcombe Blvd A267, Houston, Texas 77025. This Agreement annuls and voids all previous agreements.'}
                        </p>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">OVERVIEW</h2>
                            <p className="mb-4">
                                {'The Site (chatbotboy.ai) is operated by . Throughout the Site, the terms "we", "us" and "our" refer to . offers this Site, including all information, tools and services available from this Site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.'}
                            </p>
                            <p className="mb-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 1 – GENERAL TERMS</h2>
                            <p className="mb-4">
                            ...
                            <p className="mb-2">We have the right, but not the obligation, to take any of the following actions in our sole discretion at any time and for any reason without giving you any prior notice:</p>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 2 – CREATING AN ACCOUNT</h2>
                            <p className="mb-4">
                            ...
                            <p className="mb-2">Furthermore, the registering party hereby acknowledges, understands and agrees to:</p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400">
                            ...
                            <p>
                                {'If anyone knowingly provides any information of a false, untrue, inaccurate or incomplete nature, Chatbot Boy will have sufficient grounds and rights to suspend or terminate the member in violation of this aspect of the Agreement, and as such refuse any and all current or future use of Chatbot Boy Services, or any portion thereof.'}
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 3 – CONDUCT</h2>
                            <p className="mb-4">
                            ...
                            <p className="mb-2">{'Furthermore, you herein agree not to make use of Chatbot Boy\'s Services for the purpose of:'}</p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400">
                                ...
                                <li>interfering with or disrupting any Chatbot Boy Services, servers and/or networks that may be connected or related to our website, including, but not limited to, the use of any device software and/or routine to bypass the robot exclusion headers;</li>
                            ...
                            <p className="mb-4">
                                {'Chatbot Boy herein reserves the right to pre-screen, refuse and/or delete any content currently available through our Services. In addition, we reserve the right to remove and/or delete any such content that would violate the Terms or which would otherwise be considered offensive to other visitors, users and/or members.'}
                            </p>
                            <p className="mb-2">Chatbot Boy herein reserves the right to access, preserve and/or disclose member account information and/or content if it is requested to do so by law or in good faith belief that any such action is deemed reasonably necessary for:</p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400">
                                ...
                                <li>protecting the rights, property or the personal safety of Chatbot Boy, its visitors, users and members, including the general public.</li>
                            </ul>
                            <p>
                                Chatbot Boy herein reserves the right to include the use of security components that may permit digital information or material to be protected, and that such use of information and/or material is subject to usage guidelines and regulations established by Chatbot Boy or any other content providers supplying content services to Chatbot Boy. You are hereby prohibited from making any attempt to override or circumvent any of the embedded usage rules in our Services. Furthermore, unauthorized reproduction, publication, distribution, or exhibition of any information or materials supplied by our Services, despite whether done so in whole or in part, is expressly prohibited.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 4 – GLOBAL USE; EXPORT/IMPORT COMPLIANCE</h2>
                            <p className="mb-4">
                            ...
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400">
                                <li>are not on the list of prohibited individuals which may be identified on any government export exclusion report (http://www.bis.doc.gov/complianceandenforcement/liststocheck.htm) nor a member of any other government which may be part of an export-prohibited country identified in applicable export and import laws and regulations;</li>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 5 – SUBMITTED CONTENT</h2>
                            <p className="mb-4">
                                Chatbot Boy shall not lay claim to ownership of any content submitted by any visitor, member, or user, nor make such content available for inclusion on our website Services. Therefore, you hereby grant and allow for Chatbot Boy the below listed worldwide, royalty-free and nonexclusive licenses, as applicable:
                            </p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400">
                                <li>{"The content submitted or made available for inclusion on the publicly accessible areas of Chatbot Boy's Sites, the license provided to permit to use, distribute, reproduce, modify, adapt, publicly perform and/or publicly display said Content on our network Services is for the sole purpose of providing and promoting the specific area to which this content was placed and/or made available for viewing. This license shall be available so long as you are a member of Chatbot Boy's sites, and shall terminate at such time when you elect to discontinue your membership."}</li>
                                <li>{"Photos, audio, video and/or graphics submitted or made available for inclusion on the publicly accessible areas of Chatbot Boy's sites, the license provided to permit to use, distribute, reproduce, modify, adapt, publicly perform and/or publicly display said Content on our network Services are for the sole purpose of providing and promoting the specific area in which this content was placed and/or made available for viewing. This license shall be available so long as you are a member of Chatbot Boy's sites and shall terminate at such time when you elect to discontinue your membership."}</li>
                                <li>{"For any other content submitted or made available for inclusion on the publicly accessible areas of Chatbot Boy's sites, the continuous, binding and completely sublicensable license which is meant to permit to use, distribute, reproduce, modify, adapt, publish, translate, publicly perform and/or publicly display said content, whether in whole or in part, and the incorporation of any such Content into other works in any arrangement or medium current used or later developed."}</li>
                            </ul>
                            <p>
                                {'Those areas which may be deemed "publicly accessible" areas of Chatbot Boy\'s Sites are those such areas of our network properties which are meant to be available to the general public, and which would include message boards and groups that are openly available to both users and members. However, those areas which are not open to the public, and thus available to members only, would include our mail system and instant messaging.'}
                            </p>

                            <h3 className="text-xl font-medium text-white mt-8 mb-4">CONTRIBUTIONS TO COMPANY WEBSITE</h3>
                            <p className="mb-2">{'Chatbot Boy may provide an area for our user and members to contribute feedback to our website. When you submit ideas, documents, suggestions and/or proposals ("Contributions") to our site, you acknowledge and agree that:'}</p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400">
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 6 – INDEMNITY</h2>
                            <p>
                                All users and/or members agree to insure and hold Chatbot Boy, our subsidiaries, affiliates, agents, employees, officers, partners and/or licensors blameless or not liable for any claim or demand, which may include, but is not limited to, reasonable attorney fees made by any third party which may arise from any content a member or user of our Site may submit, post, modify, transmit or otherwise make available through our Services, the use of Services or your connection with these Services, your violations of the Terms of Service and/or your violation of any such rights of another person.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 7 – COMMERCIAL REUSE OF SERVICES</h2>
                            <p>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 8 – MODIFICATIONS</h2>
                            <p>
                                Chatbot Boy reserves the right at any time it may deem fit, to modify, alter and or discontinue, whether temporarily or permanently, our service, or any part thereof, with or without prior notice. In addition, we shall not be held liable to you or to any third party for any such alteration, modification, suspension and/or discontinuance of our Services, or any part thereof.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 9 – TERMINATION</h2>
                            <p className="mb-4">
                                As a member of chatbotboy.ai, you may cancel or terminate your account, associated email address and/or access to our Services by submitting a cancellation or termination request to . As a member, you agree that Chatbot Boy may, without any prior written notice, immediately suspend, terminate, discontinue and/or limit your account, any email associated with your account, and access to any of our Services. The cause for such termination, discontinuance, suspension and/or limitation of access shall include, but is not limited to:
                            </p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400">
                                ...
                                <li>the nonpayment of any associated fees that may be owed by you in connection with your chatbotboy.ai account Services.</li>
                            </ul>
                            <p className="mb-4">
                                Furthermore, you herein agree that any and all terminations, suspensions, discontinuances, and or limitations of access for cause shall be made at our sole discretion and that we shall not be liable to you or any other third party with regards to the termination of your account, associated email address and/or access to any of our Services.
                            </p>
                            <p className="mb-2">The termination of your account with chatbotboy.ai shall include any and/or all of the following:</p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400">
                                <li>the removal of any access to all or part of the Services offered within chatbotboy.ai;</li>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 10 – LINKS</h2>
                            <p>
                                Either Chatbot Boy or any third parties may provide links to other websites and/or resources. Thus, you acknowledge and agree that we are not responsible for the availability of any such external sites or resources, and as such, we do not endorse nor are we responsible or liable for any content, products, advertising or any other materials, on or available from such third-party sites or resources. Furthermore, you acknowledge and agree that Chatbot Boy shall not be responsible or liable, directly or indirectly, for any such damage or loss which may be a result of, caused or allegedly to be caused by or in connection with the use of or the reliance on any such content, goods or Services made available on or through any such site or resource.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 11 – PROPRIETARY RIGHTS</h2>
                            <p className="mb-4">
                                {"You do hereby acknowledge and agree that Chatbot Boy's Services and any essential software that may be used in connection with our Services (\"Software\") shall contain proprietary and confidential material that is protected by applicable intellectual property rights and other laws. Furthermore, you herein acknowledge and agree that any Content which may be contained in any advertisements or information presented by and through our Services or by advertisers is protected by copyrights, trademarks, patents or other proprietary rights and laws. Therefore, except for that which is expressly permitted by applicable law or as authorized by Chatbot Boy or such applicable licensor, you agree not to alter, modify, lease, rent, loan, sell, distribute, transmit, broadcast, publicly perform and/or created any plagiaristic works which are based on Chatbot Boy Services (e.g. Content or Software), in whole or part."}
                            </p>
                            <p>
                                Chatbot Boy hereby grants you a personal, non-transferable and non-exclusive right and/or license to make use of the object code or our Software on a single computer, as long as you do not, and shall not, allow any third party to duplicate, alter, modify, create or plagiarize work from, reverse engineer, reverse assemble or otherwise make an attempt to locate or discern any source code, sell, assign, sublicense, grant a security interest in and/or otherwise transfer any such right in the Software. Furthermore, you do herein agree not to alter or change the Software in any manner, nature or form, and as such, not to use any modified versions of the Software, including and without limitation, for the purpose of obtaining unauthorized access to our Services. Lastly, you also agree not to access or attempt to access our Services through any means other than through the interface which is provided by Chatbot Boy for use in accessing our Services.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 12 – WARRANTY DISCLAIMERS</h2>
                            <p className="mb-4 font-medium text-white uppercase">YOU HEREIN EXPRESSLY ACKNOWLEDGE AND AGREE THAT:</p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-4 text-zinc-400">
                                <li>
                                    <span className="uppercase text-white">{'THE USE OF CHATBOT BOY SERVICES AND SOFTWARE ARE AT THE SOLE RISK BY YOU. OUR SERVICES AND SOFTWARE SHALL BE PROVIDED ON AN "AS IS" AND/OR "AS AVAILABLE" BASIS. CHATBOT BOY AND OUR SUBSIDIARIES, AFFILIATES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS EXPRESSLY DISCLAIM ANY AND ALL WARRANTIES OF ANY KIND WHETHER EXPRESSED OR IMPLIED, INCLUDING, BUT NOT LIMITED TO ANY IMPLIED WARRANTIES OF TITLE, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.'}</span>
                                </li>
                                <li>
                                    <span className="uppercase text-white">{'CHATBOT BOY AND OUR SUBSIDIARIES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS MAKE NO SUCH WARRANTIES THAT (i) CHATBOT BOY SERVICES OR SOFTWARE WILL MEET YOUR REQUIREMENTS; (ii) CHATBOT BOY SERVICES OR SOFTWARE SHALL BE UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE; (iii) THAT SUCH RESULTS WHICH MAY BE OBTAINED FROM THE USE OF THE CHATBOT BOY SERVICES OR SOFTWARE WILL BE ACCURATE OR RELIABLE; (iv) QUALITY OF ANY PRODUCTS, SERVICES, ANY INFORMATION OR OTHER MATERIAL WHICH MAY BE PURCHASED OR OBTAINED BY YOU THROUGH OUR SERVICES OR SOFTWARE WILL MEET YOUR EXPECTATIONS; AND (v) THAT ANY SUCH ERRORS CONTAINED IN THE SOFTWARE SHALL BE CORRECTED.'}</span>
                                </li>
                                <li>
                                    <span className="uppercase text-white">ANY INFORMATION OR MATERIAL DOWNLOADED OR OTHERWISE OBTAINED BY WAY OF CHATBOT BOY SERVICES OR SOFTWARE SHALL BE ACCESSED BY YOUR SOLE DISCRETION AND SOLE RISK, AND AS SUCH YOU SHALL BE SOLELY RESPONSIBLE FOR AND HEREBY WAIVE ANY AND ALL CLAIMS AND CAUSES OF ACTION WITH RESPECT TO ANY DAMAGE TO YOUR COMPUTER AND/OR INTERNET ACCESS, DOWNLOADING AND/OR DISPLAYING, OR FOR ANY LOSS OF DATA THAT COULD RESULT FROM THE DOWNLOAD OF ANY SUCH INFORMATION OR MATERIAL.</span>
                                </li>
                                <li>
                                    <span className="uppercase text-white">NO ADVICE AND/OR INFORMATION, DESPITE WHETHER WRITTEN OR ORAL, THAT MAY BE OBTAINED BY YOU FROM CHATBOT BOY OR BY WAY OF OR FROM OUR SERVICES OR SOFTWARE SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED IN THE TERMS.</span>
                                </li>
                                <li>
                                    <span className="uppercase text-white">A SMALL PERCENTAGE OF SOME USERS MAY EXPERIENCE SOME DEGREE OF EPILEPTIC SEIZURE WHEN EXPOSED TO CERTAIN LIGHT PATTERNS OR BACKGROUNDS THAT MAY BE CONTAINED ON A COMPUTER SCREEN OR WHILE USING OUR SERVICES. CERTAIN CONDITIONS MAY INDUCE A PREVIOUSLY UNKNOWN CONDITION OR UNDETECTED EPILEPTIC SYMPTOM IN USERS WHO HAVE SHOWN NO HISTORY OF ANY PRIOR SEIZURE OR EPILEPSY. SHOULD YOU, ANYONE YOU KNOW OR ANYONE IN YOUR FAMILY HAVE AN EPILEPTIC CONDITION, PLEASE CONSULT A PHYSICIAN IF YOU EXPERIENCE ANY OF THE FOLLOWING SYMPTOMS WHILE USING OUR SERVICES: DIZZINESS, ALTERED VISION, EYE OR MUSCLE TWITCHES, LOSS OF AWARENESS, DISORIENTATION, ANY INVOLUNTARY MOVEMENT, OR CONVULSIONS.</span>
                                </li>
                            </ul>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 13 – LIMITATION OF LIABILITY</h2>
                            <p className="mb-4 uppercase text-white font-medium">
                                YOU EXPLICITLY ACKNOWLEDGE, UNDERSTAND AND AGREE THAT CHATBOT BOY AND OUR SUBSIDIARIES, AFFILIATES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS SHALL NOT BE LIABLE TO YOU FOR ANY PUNITIVE, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, INCLUDING, BUT NOT LIMITED TO, DAMAGES WHICH MAY BE RELATED TO THE LOSS OF ANY PROFITS, GOODWILL, USE, DATA AND/OR OTHER INTANGIBLE LOSSES, EVEN THOUGH WE MAY HAVE BEEN ADVISED OF SUCH POSSIBILITY THAT SAID DAMAGES MAY OCCUR, AND RESULT FROM:
                            </p>
                            <ul className="list-[lower-alpha] pl-6 mb-4 space-y-2 text-zinc-400 uppercase">
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 14 – RELEASE</h2>
                            <p>
                                In the event you have a dispute, you agree to release Chatbot Boy (and its officers, directors, employees, agents, parent subsidiaries, affiliates, co-branders, partners and any other third parties) from claims, demands and damages (actual and consequential) of every kind and nature, known and unknown, suspected or unsuspected, disclosed and undisclosed, arising out of or in any way connected to such dispute.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 15 – NOTICE</h2>
                            <p>
                                Chatbot Boy may furnish you with notices, including those with regards to any changes to the Terms, including but not limited to email, regular mail, MMS or SMS, text messaging, postings on our website Services, or other reasonable means currently known or any which may be herein after developed. Any such notices may not be received if you violate any aspects of the Terms by accessing our Services in an unauthorized manner. Your acceptance of this Agreement constitutes your agreement that you are deemed to have received any and all notices that would have been delivered had you accessed our Services in an authorized manner.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 16 – INTELLECTUAL PROPERTY RIGHTS</h2>
                            <p className="mb-4">
                                {"You herein acknowledge, understand and agree that all of the Chatbot Boy trademarks, copyright, trade name, service marks, and other Chatbot Boy logos and any brand features, and/or product and service names are trademarks and as such, are and shall remain the property of Chatbot Boy. You herein agree not to display and/or use in any manner the Chatbot Boy logo or marks without obtaining Chatbot Boy's prior written consent."}
                            </p>
                            <p className="mb-2">
                                Chatbot Boy will always respect the intellectual property of others, and we ask that all of our users do the same. With regards to appropriate circumstances and at its sole discretion, Chatbot Boy may disable and/or terminate the accounts of any user who violates our Terms and/or infringes the rights of others. If you feel that your work has been duplicated in such a way that would constitute copyright infringement, or if you believe your intellectual property rights have been otherwise violated, you should provide to us the following information:
                            </p>
                            <ul className="list-[lower-alpha] pl-6 mb-6 space-y-2 text-zinc-400">
                            ...
                            <p className="mb-2">The Chatbot Boy agent for notice of claims of copyright or other intellectual property infringement can be contacted as follows:</p>
                            <div className="bg-zinc-900/50 p-6 rounded-xl border border-zinc-800 text-zinc-400">
                                <p className="font-medium text-white mb-2">Mailing Address:</p>
                                <p>Chatbot Boy</p>
                                <p>Attn: Copyright Agent</p>
                                <p>3139 W Holcombe Blvd A267</p>
                                <p>Houston, Texas 77025</p>
                                <p className="mt-4"><span className="font-medium text-white">Telephone:</span> 6014545763</p>
                                <p><span className="font-medium text-white">Email:</span> info@chatbotboy.ai</p>
                            </div>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 17 – ENTIRE AGREEMENT</h2>
                            <p>
                                This Agreement constitutes the entire agreement between you and Chatbot Boy and shall govern the use of our Services, superseding any prior version of this Agreement between you and us with respect to Chatbot Boy Services. You may also be subject to additional terms and conditions that may apply when you use or purchase certain other Chatbot Boy Services, affiliate Services, third-party content or third-party software.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 18 – CHOICE OF LAW AND FORUM</h2>
                            <p>
                                It is at the mutual agreement of both you and Chatbot Boy with regard to the Agreement that the relationship between the parties shall be governed by the laws of the state of Texas without regard to its conflict of law provisions and that any and all claims, causes of action and/or disputes, arising out of or relating to the Agreement, or the relationship between you and Chatbot Boy, shall be filed within the courts having jurisdiction within the County of Harris, Texas or the U.S. District Court located in said state. You and Chatbot Boy agree to submit to the jurisdiction of the courts as previously mentioned, and agree to waive any and all objections to the exercise of jurisdiction over the parties by such courts and to venue in such courts.
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 19 – WAIVER AND SEVERABILITY OF TERMS</h2>
                            <p>
                                {"At any time, should Chatbot Boy fail to exercise or enforce any right or provision of the Agreement, such failure shall not constitute a waiver of such right or provision. If any provision of this Agreement is found by a court of competent jurisdiction to be invalid, the parties nevertheless agree that the court should endeavor to give effect to the parties' intentions as reflected in the provision, and the other provisions of the Agreement remain in full force and effect."}
                            </p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 20 – NO RIGHT OF SURVIVORSHIP NONTRANSFERABILITY</h2>
                            <p>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 21 – STATUTE OF LIMITATIONS</h2>
                            <p>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 22 – VIOLATIONS</h2>
                            <p className="mb-2">Please report any and all violations of this Agreement to Chatbot Boy as follows:</p>
                            <div className="bg-zinc-900/50 p-6 rounded-xl border border-zinc-800 text-zinc-400">
                                <p className="font-medium text-white mb-2">Mailing Address:</p>
                                <p>Chatbot Boy</p>
                                <p>3139 W Holcombe Blvd A267</p>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 23 – GOVERNMENT REQUESTS</h2>
                            <p>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 24 – FOREIGN ACCESS OF SITE</h2>
                            <p>
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 25 – ERRORS, INACCURACIES AND OMISSIONS</h2>
                            <p className="mb-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">SECTION 26 – PRIVACY POLICY</h2>
                            <p>
                                {"Every member's registration data and various other personal information are strictly protected by the Chatbot Boy Online Privacy Policy (see the full Privacy Policy at https://chatbotboy.ai/privacy-policy/). As a member, you herein consent to the collection and use of the information provided, including the transfer of information within the United States and/or other countries for storage, processing or use by Chatbot Boy and/or our subsidiaries and affiliates."}
                            </p>
                        </div>
